Feature: Map
  ...
  Scenario: Text on the map should be translated
    ...
    And I should see "Female-translated"
    And I should see "Male-translated"
    And I should see "Rural-translated - Female-translated"
    And I should see "Urban-translated - Female-translated"
    And I should see "Rural-translated - Male-translated"
    And I should see "Urban-translated - Male-translated"
